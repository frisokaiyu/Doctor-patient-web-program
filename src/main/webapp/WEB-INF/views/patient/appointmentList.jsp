...
<html>
<head>
<title>Medical Appointment System | Appointment List :: Patient</title>
<!-- for-mobile-apps -->
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="appointmentRec" class="menu__link">Recent Appointment Record</a></li> 
...
<div class="ind-team">
	<div class="container">
		<h3 class="tittle">Recent Appointment Record</h3>
		<table width="100%" style="border-color: #00A4E4; border-width:3px; border-style:solid; padding:5px;">
			...
			<tr>
				<c:forEach var="apporder" items="${apporderList }">
				
					<tr>
						<td width="10%">${apporder.id }</a></td>
						<td width="30%">${apporder.appointdate }</td>
						<td width="30%">${apporder.appointtime }</td>
						<td width="30%">${apporder.doctorname }</td>
					</tr>

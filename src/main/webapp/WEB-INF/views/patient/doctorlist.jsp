...
<div class="ind-team">
	<div class="container">
		<h3 class="tittle">Appointment</h3>
		<table align="center" width="100%" style="border-color: #00A4E4; border-width:3px; border-style:solid; padding:5px;">
			<tr >
				<td><h4>Name</h4></td>
			...
			<c:forEach var="doctor" items="${doctorList }">
				<tr>
					<td><a href="timetable?doctorid=${doctor.id }&date=${date}">${doctor.firstname }</a></td>

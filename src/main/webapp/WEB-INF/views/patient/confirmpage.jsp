...
<div class="ind-team">
	<div class="container" align="center" >
		<h3 class="tittle">Confirm Order</h3>
		<table width="50%" style="border-color: #00A4E4; border-width:3px; border-style:solid; padding:5px;">
			<tr >
			<td><h4>Doctor:</h4></td>
			<td align="center">${Dfirstname} ${Dlastname}</td>
			</tr>
		...
		<div align="center">
		<button id="btnComfirm" type= "button" class="btn btn-info" onclick= "comfirmappo()">confirm the order</button>
		</div>
...
<script type="text/javascript">
	function comfirmappo(){
		var url = "comfirmappo" + window.location.search;

...
<html>
<head>
<title>Medical Appointment System | Password Modification :: Patient</title>
<!-- for-mobile-apps -->
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="passmodifyPat" class="menu__link">Password Modification</a></li>
	...
	<div class="container">
		<form action="" class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" value="${sessionScope.patient.username }" readonly="readonly" id="username" name="username" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
				<label for="currentPwd" class="col-sm-2 control-lable">Current Password:</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<label for="repassword" class="col-sm-2 control-lable">Confirm Password:</label>
				<div class="col-sm-4">
